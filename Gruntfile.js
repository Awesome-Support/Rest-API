...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		jshint: {
			all: ['Gruntfile.js', 'assets/admin/js/admin.js']
		},
		...
		combine_mq: {
			...
			adminCSS: {
				src: 'assets/admin/css/admin.css',
				dest: 'assets/admin/css/admin.css'
			}
		},
		...
		makepot: {
			target: {
				options: {
					...
					mainFile: 'awesome-support-api.php',
					potComments: 'Awesome Support API',
					potFilename: 'awesome-support-api.pot',
					potHeaders: {
						poedit: true,
